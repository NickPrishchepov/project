...
<ul class="menu">
    ...
    <form action="addprediction.jsp" name="form">
    ...
    <div class="container">
        <div class="abou-main">
            <div class="about-top">
                ...
                <p><fmt:message key="addprediction_text"/></p>
            </div>
            <div class="clearfix"> </div>
        </div>
    </div>
        ...
        <div class="contact-main">
            ...
            <div class="contact-bottom">
                <form method="post" action="controller">
                    <input type="hidden" name="command" value="ADD_PREDICTION"/>
                    <div class="col-md-6 contact-right">
                        <input type="number" step="any" name="attr" min="100" placeholder="<fmt:message key="money"/> " value="" required/>
