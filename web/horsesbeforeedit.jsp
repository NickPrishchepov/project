...
<ul class="menu">
    ...
    <form action="horsesbeforeedit.jsp" name="form">
        ...
        <div class="col-md-6 col-sm-6 about-grid">
            ...
            <div class = "about_block">
                <form name="edit" method="POST" action="controller">
                    <input type="hidden" name="command" value="SET_HORSE_PARAMETERS_BEFORE_EDIT_BET"/>
                    ...
                    <table>
                        ...
                        <c:forEach var="post" items="${horses}">
                            <tr>
                                ...
                                <td>${post.breed}</td>
                                <td>${post.age}</td>
                                <td>${post.jockeyName}</td>
                                <td>${post.rating}</td><td><button name="attribute" value="${post.id}" type="submit"><fmt:message key="choose"/> </button></td></tr>
                        </c:forEach>
                        </tbody>
                    </table>
                </form>
