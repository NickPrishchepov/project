...
<ul class="menu">
    ...
    <form action="quotationbeforeadd.jsp" name="form">
    ...
    <div class="container">
        <div class="header-main">
            <div class="header-left">
                <div class="logo">
                    <h1><a href="index.html">Horse Races</a></h1>
                </div>
    ...
    <c:otherwise>
            <div class = "pred_block">
                <form name="action" method="post" action="controller">
                    <input type="hidden" name="command" value="SET_QUOTATION_PARAMETERS_BEFORE_ADD_PREDICTION">
                    <table>
                        <thead>
                        <tr>
                        ...
                        <c:forEach var="post" items="${list}">
                            <tr>
                                ...
                                <td><button name="attribute" value="${post.id}" type="submit"><fmt:message key="choose"/></button></td></tr>
                        </c:forEach>
                        </tbody>
                    </table>
                </form>
