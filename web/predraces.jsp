...
<ul class="menu">
    ...
    <form action="predraces.jsp" name="form">
            ...
            <div class = "pred_block">
                <form name="action" method="post" action="controller">
                    ...
                    <table class="table-fill">
                        <thead>
                        <tr>
                            <th class="text-left"><fmt:message key="date"/></th>
                            <th class="text-left"><fmt:message key="location"/></th>
                            <th class="text-left"><fmt:message key="type"/></th>
                        </tr>
                        </thead>
                        ...
                        <c:forEach var="post" items="${race_list}">
                            ...
                            <td class="text-left">${post.location}</td>
                            <td class="text-left">${post.type}</td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
